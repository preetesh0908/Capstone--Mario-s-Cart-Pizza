...
$sanbdisplaystatus = mysqli_real_escape_string ($con, $_POST["form_DisplayStatus"]);
...
$sql = "UPDATE Events SET EventTitle = '$sanbeventtitle', EventDate = '$sanbeventdate', EventVenue = '$sanbeventlocation', EventDescription = '$sanbeventdescription', EventStatus = '$sanbeventstatus' WHERE EventID = $sanbeventid AND $sanbdisplaystatus = 1" ;
