...
$sql = "UPDATE Events SET EventTitle = '$sanbeventtitle', EventDate = '$sanbeventdate', EventVenue = '$sanbeventlocation', EventDescription = '$sanbeventdescription', EventStatus = '$sanbeventstatus' WHERE EventID = $sanbeventid";
